	...
	<div class="wrapper"> 
		...
		<div class="content-wrapper"> 
			...
			<section class="content-header"> 
				<h1> 
					作业计划制定 <small>作业计划制定设置</small> 
				</h1> 
				<ol class="breadcrumb"> 
					<li><a href="#"><i class="fa fa-dashboard"></i> 首页</a></li> 
					<li class="active">作业计划制定</li> 
				</ol> 
			</section> 
					...
					<div class="col-md-12"> 
						<div class="box box-primary"> 
							<div class="box-header with-border"> 
								<h3 class="box-title">作业计划制定</h3> 
							</div> 
							<!-- /.box-header --> 
							<!-- form start --> 
							<form role="form" id="form1"
								action="workplan?action=update&wP_ID=${model.wp_ID}" 
								method="post"> 
								<div class="box-body"> 

									<div class="form-group"> 
										<label for="wP_IsTemp">计划类别</label>
										<select class="form-control" id="wP_IsTemp" name="wP_IsTemp" placeholder="请选择计划类别" readonly>
											<option value="0">临时性计划</option>
											
											<c:if test="${model.wp_IsTemp == 0}">
												<option value="0" selected="selected">临时性计划</option>
												<option value="1">周期性计划</option>
											</c:if>
											
											<c:if test="${model.wp_IsTemp == 1}">
												<option value="1" selected="selected">周期性计划</option>
												<option value="0">临时性计划</option>
											</c:if>
										...
										<%--  <input type="text" 
											class="form-control" id="wP_IsTemp" name="wP_IsTemp" 
											placeholder="wP_IsTemp" value="${model.wP_IsTemp}">  --%>
									</div> 
									 <div class="form-group"> 
										<label for="wP_Date">工作日期</label> <input type="text" 
											class="form-control" id="wP_Date" name="wP_Date" 
											placeholder="wP_Date" value="${model.wp_Date}"> 
									</div>  
									<div class="form-group"> 
										<label for="wP_Address">计划工作地点</label> <input type="text" 
											class="form-control" id="wP_Address" name="wP_Address" 
											placeholder="wP_Address" value="${model.wp_Address}"> 
									</div> 
									<div class="form-group"> 
										<label for="wP_Content">计划工作内容</label> <input type="text" 
											class="form-control" id="wP_Content" name="wP_Content" 
											placeholder="wP_Content" value="${model.wp_Content}"> 
									</div> 
									<div class="form-group"> 
										<label for="users_ID">执行人</label> 
										<select class="form-control" id="users_ID" name="users_ID" readonly>
											<!--思路：取到Users，循环遍历到option里  -->
											<option value="0">****请选择执行人****</option>
											<c:forEach items="${users}" var="user">
											<c:if test="${user.users_ID == model.users_ID}">
												<option value="${user.users_ID }" selected="selected">${user.users_UserName}</option>
