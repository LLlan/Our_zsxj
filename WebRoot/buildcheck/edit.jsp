	...
	<div class="wrapper"> 
		...
		<div class="content-wrapper"> 
			...
			<section class="content-header"> 
				<h1> 
					系统设置 <small>施工管理设置</small> 
				</h1> 
				<ol class="breadcrumb"> 
					<li><a href="#"><i class="fa fa-dashboard"></i> 首页</a></li> 
					<li class="active">施工管理</li> 
				</ol> 
			</section> 
					...
					<div class="col-md-12"> 
						<div class="box box-primary"> 
							<div class="box-header with-border"> 
								<h3 class="box-title">施工管理</h3> 
							</div> 
							<!-- /.box-header --> 
							<!-- form start --> 
							<form role="form" 
								action="buildcheck?action=update&bC_ID=${model.bc_ID}" 
								...
								<div class="box-body"> 
									...
									<div class="form-group"> 
										<label for="bC_Address">地点</label> <input type="text" 
											class="form-control" id="bC_Address" name="bC_Address" 
											placeholder="请输入地点" value="${model.bc_Address}"> 
									</div> 
									<div class="form-group"> 
										<label for="bC_Project">项目名称</label> <input type="text" 
											class="form-control" id="bC_Project" name="bC_Project" 
											placeholder="请输入项目名称" value="${model.bc_Project}"> 
									</div> 
									<div class="form-group"> 
										<label for="bC_ProjectDesc">工程情况</label> <input type="text" 
											class="form-control" id="bC_ProjectDesc" name="bC_ProjectDesc" 
											placeholder="请输入工程情况" value="${model.bc_ProjectDesc}"> 
									</div> 
									<div class="form-group"> 
										<label for="users_ID">施工人ID</label> <input type="text" 
											class="form-control" id="users_ID" name="users_ID" 
											placeholder="请输入施工人ID" value="${model.users_ID}"> 
									</div> 
