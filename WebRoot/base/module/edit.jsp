					...
					<div class="col-md-12"> 
						<div class="box box-primary"> 
							...
							<form role="form"  id = "form1"
								action="module?action=update&module_ID=${model.module_ID}" 
								method="post"> 
								<div class="box-body"> 
 
									<div class="form-group"> 
										<label for="module_Name">模块名称</label> <input type="text" 
											class="form-control" id="module_Name" name="module_Name" 
											placeholder="module_Name" value="${model.module_Name}"> 
									</div> 
									<div class="form-group"> 
										<label for="module_Code">模块代码</label> <input type="text" 
											class="form-control" id="module_Code" name="module_Code" 
											placeholder="module_Code" value="${model.module_Code}"> 
									</div> 
									<div class="form-group"> 
										<label for="module_OrderBy">模块排序</label> <input type="text" 
											class="form-control" id="module_OrderBy" name="module_OrderBy" 
											placeholder="module_OrderBy" value="${model.module_OrderBy}"> 
									</div> 
