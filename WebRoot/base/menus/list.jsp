...
<link rel="stylesheet" type="text/css" media="screen" 
	href="${ctx}/plugins/treegrid/styles/jqx.base.css" /> 
	<link rel="stylesheet" type="text/css" media="screen" 
	href="${ctx}/plugins/treegrid/styles/jqx.bootstrap.css" /> 
...
<body class="hold-transition skin-blue sidebar-mini"> 
					...
					<div class="col-xs-12"> 
						<div class="box"> 
								...
								<div class="box-tools list-inline"> 
									<ul class="list-inline"> 
										<li><a class="btn btn-block btn-success btn-flat" 
											href="${ctx}/base/menus/add.jsp">添加菜单</a></li> 
										<li><a class="btn btn-block btn-info btn-flat" href="#" 
											onclick="javascript:editRow();">修改菜单</a></li> 
 
										<li><a class="btn btn-block btn-danger btn-flat" href="#" 
											onclick="javascript:delRows();">删除菜单</a></li> 
									</ul> 
								</div> 
							...
							<div class="box-body table-responsive " style="margin-left:20px"> 
								<div id="treeGrid" class="table table-striped table-hover table-bordered"></div>
							</div> 
							<!-- /.box-body --> 
	...
	<script src="${ctx}/plugins/treegrid/jqxcore.js"></script>
    <script src="${ctx}/plugins/treegrid/jqxdata.js"></script>
    <script src="${ctx}/plugins/treegrid/jqxbuttons.js"></script>
    <script src="${ctx}/plugins/treegrid/jqxscrollbar.js"></script>
    <script src="${ctx}/plugins/treegrid/jqxdatatable.js"></script>
    <script src="${ctx}/plugins/treegrid/jqxtreegrid.js"></script>
	<script>
            ...
            function onSuccess(data) {
                ...
                var source =
                {
                    ...
                    dataFields: [
                        ...
                        { name: 'menus_Url', type: 'string' },
                        { name: 'menus_PID', type: 'number' },
                        { name: 'menus_Code', type: 'string' },
                        { name: 'menus_Icon', type: 'string' },
                        { name: 'menus_OrderBy', type: 'number' }
                    ],
                    hierarchy:
                    {
                        keyDataField: { name: 'menus_ID' },
                        parentDataField: { name: 'menus_PID' }
                    },
                    id: 'menus_ID',
                    localData: users
                };
                ...
                $("#treeGrid").jqxTreeGrid(
                {
                    ...
                    columns: [
                      ...
                      { text: '菜单标题', dataField: 'menus_Title', width: 120 },
                      { text: '菜单地址', dataField: 'menus_Url', width: 120 },
                      { text: '上级ID', dataField: 'menus_PID',  width: 120},
					  { text: '菜单代码', dataField: 'menus_Code',  width: 120},
					  { text: '菜单图标', dataField: 'menus_Icon',  width: 120},
					  { text: '菜单排序值', dataField: 'menus_OrderBy',  width: 120},
					  { 
						  text: '操作', cellsAlign: 'center', align: "center", columnType: 'none', editable: false, sortable: false, dataField: null, cellsRenderer: function (row, column, value) {
	                          var editMenus = "<ul class='list-inline'>";
	                          
	                          editMenus +="<li><a class='btn btn-block btn-flat btn-success' href='../menusmodule/add.jsp?menus_ID="+row+"'>添加模块</a></li>";
	                          editMenus +="<li><a class='btn btn-block btn-flat btn-info' href='menus?action=edit&menus_ID="+row+"'>编辑</a></li>";
	                          editMenus +="<li><a class='btn btn-block btn-flat btn-danger' href='menus?action=del&menus_ID="+row+"'>删除</a></li>";
	                          editMenus +="<li class='divider'></li>";
	                          editMenus +="<li><a class='btn btn-block btn-flat btn-warning' href='add.jsp'>添加菜单</a></li>";
	                          editMenus +="</ul>";
	                          return editMenus;
	                      }
					  }
