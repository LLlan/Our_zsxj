						...
						<div class="box box-primary"> 
							...
							<form role="form" id = "form1"
								...
								<div class="box-body"> 
									...
									<div class="form-group"> 
										<label for="log_Date">日志日期</label> <input type="text" 
									...
									<div class="form-group"> 
										<label for="log_IP">日志IP</label> 
						                 ...
						                 <input id="log_IP" name="log_IP" type="text" class="form-control" data-inputmask="'alias': 'ip'" data-mask>
