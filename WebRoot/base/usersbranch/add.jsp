								...
								<div class="box-body"> 
									...
									<div class="form-group"> 
										<label for="branch_PID">父级部门</label> 
                                             ...
                                             <input type="text"
											class="form-control" id="branch_PName" name="branch_PName"
											placeholder="请选择上级部门" readonly
											data-toggle="modal" data-target="#myModal" />
											
											<input type="hidden" id="branch_PID" name="branch_PID"/>
									</div> 
									<div class="form-group"> 
		...
		<!--
			...
			function getTreeNode() {
				...
				for (var i = 0; i < nodes.length; i++) {
					//v += nodes[i].menus_ID + ",";
					$("#branch_PID").val(nodes[0].branch_ID);
					$("#branch_PName").val(nodes[0].branch_Name);
					$('#myModal').modal('hide');
				} 
			}
