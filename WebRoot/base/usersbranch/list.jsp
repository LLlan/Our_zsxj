	...
	<div class="wrapper"> 
		...
		<div class="content-wrapper"> 
			...
			<section class="content-header"> 
				<h1> 
					系统设置 <small>用户部门</small> 
				</h1> 
				<ol class="breadcrumb"> 
					<li><a href="#"><i class="fa fa-dashboard"></i> 首页</a></li> 
					<li class="active">用户部门</li> 
				</ol> 
			</section> 
            ...
            function onSuccess(data) {
                ...
                var source =
                {
                    ...
                    dataFields: [
                        ...
                        { name: 'branch_PID', type: 'string' },
                        { name: 'branch_Code', type: 'number' },
                        { name: 'branch_OrderBy', type: 'string' }
                    ],
                    hierarchy:
                    {
                        keyDataField: { name: 'branch_ID' },
                        parentDataField: { name: 'branch_PID' }
                    },
                    id: 'branch_ID',
                    localData: users
                };
                ...
                $("#treeGrid").jqxTreeGrid(
                {
                    ...
                    columns: [
                      ...
                      { text: '部门ID', dataField: 'branch_ID', width: 120 },
                      { text: '部门名称', dataField: 'branch_Name', width: 120 },
                      { text: '上级ID', dataField: 'branch_PID',  width: 120},
					  { text: '部门编码', dataField: 'branch_Code',  width: 120},
					  { text: '部门排序', dataField: 'branch_OrderBy',  width: 120},
					  { 
						  text: '操作', cellsAlign: 'center', align: "center", columnType: 'none', editable: false, sortable: false, dataField: null, cellsRenderer: function (row, column, value) {
	                          ...
	                          editMenus +="<li><a class='btn btn-block btn-flat btn-success' href='../menusmodule/add.jsp?branch_ID="+row+"'>添加模块</a></li>";
	                          editMenus +="<li><a class='btn btn-block btn-flat btn-info' href='usersbranch?action=edit&branch_ID="+row+"'>编辑</a></li>";
	                          editMenus +="<li><a class='btn btn-block btn-flat btn-danger' href='usersbranch?action=del&branch_ID="+row+"'>删除</a></li>";
