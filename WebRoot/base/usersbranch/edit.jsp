					...
					<div class="col-md-12"> 
						<div class="box box-primary"> 
							...
							<form role="form" id = "form1"
								action="usersbranch?action=update&branch_ID=${model.branch_ID}" 
								method="post"> 
								<div class="box-body"> 
 
 
									<div class="form-group"> 
										<label for="branch_Name">部门名称</label> <input type="text" 
											class="form-control" id="branch_Name" name="branch_Name" 
											placeholder="branch_Name" value="${model.branch_Name}"> 
									</div> 
									<div class="form-group"> 
										<label for="branch_PID">父级部门</label> 
											
											<select name="branch_PID">
                                            	<option value = "0">顶级</option>
                                            	<c:if test="${requestScope.branchs !=null }">
                                            		<c:forEach items="${requestScope.branchs}" var="branch">
                                            			
                                            			<c:if test="${requestScope.model.branch_PID != branch.branch_ID }">
									...
									<div class="form-group"> 
										<label for="branch_Code">部门代码</label> <input type="text" 
											class="form-control" id="branch_Code" name="branch_Code" 
											placeholder="branch_Code" value="${model.branch_Code}"> 
									</div> 
									<div class="form-group"> 
										<label for="branch_OrderBy">部门排序</label> <input type="text" 
											class="form-control" id="branch_OrderBy" name="branch_OrderBy" 
											placeholder="branch_OrderBy" value="${model.branch_OrderBy}"> 
									</div> 
