					...
					<div class="col-md-12"> 
						<div class="box box-primary"> 
							...
							<form role="form" id = "form1"
								action="users?action=update&users_ID=${model.users_ID}" 
								method="post"> 
								<div class="box-body"> 
 
 
									<div class="form-group"> 
										<label for="users_UserName">用户账号</label> <input type="text" 
											class="form-control" id="users_UserName" name="users_UserName" 
											placeholder="users_UserName" value="${model.users_UserName}"> 
									</div> 
									<div class="form-group"> 
										<label for="users_Password">用户密码</label> <input type="text" 
											class="form-control" id="users_Password" name="users_Password" 
											placeholder="users_Password" value="${model.users_Password}"> 
									</div> 
									<div class="form-group"> 
										<label for="users_Mobile">手机号</label> 
											
											<input  name="users_Mobile" value="${model.users_Mobile}"  type="text" class="form-control" data-inputmask="'mask': ['999-999-9999 [x99999]', '+099 99 99 9999[9]-9999']" data-mask>
									</div> 
									<div class="form-group"> 
										<label for="users_Phone">联系方式</label> 
											
											<input id="users_Phone" value="${model.users_Phone}" name="users_Phone"  type="text" class="form-control" data-inputmask='"mask": "(999) 999-9999"' data-mask>
									</div> 
									<div class="form-group"> 
										<label for="users_Email">邮箱</label> <input type="text" 
											class="form-control" id="users_Email" name="users_Email" 
											placeholder="users_Email" value="${model.users_Email}"> 
									</div> 
									<div class="form-group"> 
										<label for="users_TrueName">姓名</label> <input type="text" 
											class="form-control" id="users_TrueName" name="users_TrueName" 
											placeholder="users_TrueName" value="${model.users_TrueName}"> 
									</div> 
									<div class="form-group"> 
										<label for="users_IsLock">安全码</label> 
											
											<select id="users_IsLock" name="users_IsLock" >
											
											<c:if test="${model.users_IsLock != 0}">
												...
												<c:if test="${model.users_IsLock != 1}">
													<option value = "1">不锁定</option>
												</c:if>
												
												<c:if test="${model.users_IsLock == 1}">
													<option value = "1" selected="selected">不锁定</option>
												</c:if>
									...
									<div class="form-group"> 
										<label for="users_LastLoginTime">最后登录时间</label> <input type="text" 
											class="form-control" id="users_LastLoginTime" name="users_LastLoginTime" 
											placeholder="users_LastLoginTime" value="${model.users_LastLoginTime}"> 
									</div> 
									<div class="form-group"> 
										<label for="users_LastLoginIP">最后登录IP</label> <input type="text" 
											class="form-control" id="users_LastLoginIP" name="users_LastLoginIP" 
											placeholder="users_LastLoginIP" value="${model.users_LastLoginIP}"> 
									</div> 
									<div class="form-group"> 
											...
											<select name="branch_ID">
                                             	<c:if test="${requestScope.branchs !=null }">
                                             		<c:forEach items="${requestScope.branchs}" var="branch">
                                             			...
                                             			<c:if test="${branch.branch_ID != model.branch_ID }">
									...
									<div class="form-group"> 
										<label for="role_ID">职位ID</label> 
											
											<select name="role_ID">
                                             	<c:if test="${requestScope.roles !=null }">
                                             		<c:forEach items="${requestScope.roles}" var="role">
                                             		<c:if test="${role.role_ID != model.role_ID }">
