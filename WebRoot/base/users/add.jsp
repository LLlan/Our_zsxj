								...
								<div class="box-body"> 
									...
									<div class="form-group"> 
										<label for="users_Mobile">手机号</label> 
											<input  name="users_Mobile"  type="text" class="form-control" data-inputmask="'mask': ['999-999-9999 [x99999]', '+099 99 99 9999[9]-9999']" data-mask>
									</div> 
									<div class="form-group"> 
										<label for="users_Phone">联系方式</label> 
											<input id="users_Phone" name="users_Phone"  type="text" class="form-control" data-inputmask='"mask": "(999) 999-9999"' data-mask>
									</div> 
									<div class="form-group"> 
									...
									<div class="form-group"> 
										<label for="users_TrueName">真实姓名</label> <input type="text" 
											class="form-control" id="users_TrueName" name="users_TrueName" 
											placeholder="请输入姓名" /> 
									</div> 
									<div class="form-group"> 
										<label for="users_IsLock">是否锁定</label> 
									...
									<div class="form-group"> 
										<label for="users_LastLoginIP">最后登录IP</label> 
									
											 <input id="users_LastLoginIP" name="users_LastLoginIP" type="text" class="form-control" data-inputmask="'alias': 'ip'" data-mask>
									</div> 
									<div class="form-group"> 
