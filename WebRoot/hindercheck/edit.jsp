	...
	<div class="wrapper"> 
		...
		<div class="content-wrapper"> 
			...
			<section class="content-header"> 
				<h1> 
					系统设置 <small>障碍处理设置</small> 
				</h1> 
				<ol class="breadcrumb"> 
					<li><a href="#"><i class="fa fa-dashboard"></i> 首页</a></li> 
					<li class="active">障碍处理</li> 
				</ol> 
			</section> 
					...
					<div class="col-md-12"> 
						<div class="box box-primary"> 
							...
							<form role="form" id="form1"
								action="hindercheck?action=update&hC_ID=${model.hc_ID}" 
								method="post"> 
								<div class="box-body"> 
 
									</div> 
									<div class="form-group"> 
										<label for="hC_Address">障碍处理地址</label> <input type="text" 
											class="form-control" id="hC_Address" name="hC_Address" 
											placeholder="hC_Address" value="${model.hc_Address}"> 
									</div> 
									<div class="form-group"> 
										<label for="hC_Desc">障碍现象</label> <input type="text" 
											class="form-control" id="hC_Desc" name="hC_Desc" 
											placeholder="hC_Desc" value="${model.hc_Desc}"> 
									</div> 
									<div class="form-group"> 
										<label for="hC_Process">障碍处理过程</label> <input type="text" 
											class="form-control" id="hC_Process" name="hC_Process" 
											placeholder="hC_Process" value="${model.hc_Process}"> 
									</div> 
									<div class="form-group"> 
										<label for="hC_ProcessUserID">障碍处理人</label> 
											
                                             <input type="text" 
											class="form-control" id="hC_ProcessUserID" name="hC_ProcessUserID" 
											placeholder="请输入障碍处理人"  value = "${model.hc_ProcessUserID }"/> 
									</div> 
