					...
					<div class="col-md-12"> 
						<div class="box box-primary"> 
							<div class="box-header with-border"> 
								<h3 class="box-title">作业计划执行</h3> 
							</div> 
							<!-- /.box-header --> 
							<!-- form start --> 
							<form role="form" id="form1"
								action="wrokplanexec?action=update&wPE_ID=${model.wpe_ID}" 
								method="post"> 
								<div class="box-body"> 
									<div class="form-group"> 
										<label for="wPE_Date">执行日期</label> <input type="text" 
											class="form-control" id="wPE_Date" name="wPE_Date" 
											placeholder="wPE_Date" value="${model.wpe_Date}"> 
									</div> 
									<div class="form-group"> 
										<label for="wPE_RealAddress">计划工作地点</label> <input type="text" 
											class="form-control" id="wPE_RealAddress" name="wPE_RealAddress" 
											placeholder="wPE_RealAddress" value="${model.wpe_RealAddress}"> 
									</div> 
									<div class="form-group"> 
										<label for="wPE_RealContent">实际工作内容</label> <input type="text" 
											class="form-control" id="wPE_RealContent" name="wPE_RealContent" 
											placeholder="wPE_RealContent" value="${model.wpe_RealContent}"> 
									</div> 
									<div class="form-group"> 
										<label for="users_ID">计划制定人</label> <input type="text" 
											class="form-control" id="users_ID" name="users_ID" 
											placeholder="users_ID" value="${model.users_ID}"> 
									</div> 
									<div class="form-group"> 
										<label for="wP_ID">工作计划ID</label> <input type="text" 
											class="form-control" id="wP_ID" name="wP_ID" 
											placeholder="wP_ID" value="${model.wp_ID}"> 
									</div> 
