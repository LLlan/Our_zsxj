...
<body class="hold-transition skin-blue sidebar-mini"> 
	...
	<script type="text/javascript"> 
		$(document).ready(function() { 
			$("#jqGrid").jqGrid({ 
				url : 'adormcheck?action=listjson', 
				datatype : "json", 
				colModel : [ 
				{ 
					label : 'ID', 
		...
		function formatImage(cellValue, options, rowObject) {
            var imageHtml = "<img src='${ctx}/upload/ado/"+cellValue+"' width='50' height = '50'/>";
            return imageHtml;
		}
		...
		function editRow() { 
			...
			if (!edrowKey) 
				...
				if (edselectedIDs.length > 0) { 
					...
					location.href = "adormcheck?action=edit&aC_ID=" 
							+ edselectedIDs[0]; 
				} else { 
