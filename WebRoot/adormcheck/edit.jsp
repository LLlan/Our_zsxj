...
<link rel="stylesheet" href="${ctx}/dist/css/skins/skin-blue.min.css"> 
 <!--上传文件css样式-->
<link rel="stylesheet" href="${ctx}/plugins/fileinput/css/fileinput.min.css">
 <style>
		label.error{
			height:22px;
			color:red;
	...
	<div class="wrapper"> 
		...
		<div class="content-wrapper"> 
			...
			<section class="content-header"> 
				<h1> 
					系统设置 <small>装维管理设置</small> 
				</h1> 
				<ol class="breadcrumb"> 
					<li><a href="#"><i class="fa fa-dashboard"></i> 首页</a></li> 
					<li class="active">装维管理</li> 
				</ol> 
			</section> 
					...
					<div class="col-md-12"> 
						<div class="box box-primary"> 
							<div class="box-header with-border"> 
								<h3 class="box-title">装维管理</h3> 
							</div> 
							<!-- /.box-header --> 
							<!-- form start --> 
							<form role="form" 
								action="adormcheck?action=update&aC_ID=${model.ac_ID}" 
								method="post" enctype="multipart/form-data" id="form1"> 
								<div class="box-body"> 
									<div class="form-group">
										<label for="idcardpic">图片：</label> <input id="idcardpic" name="idcardpic"
											class="file" type="file" data-show-upload="false"
											data-min-file-count="1" multiple placeholder="请上传您的图片"
											data-allowed-file-extensions='["jpg", "png","gif","bmp"]'>
									</div>
 
							
									<div class="form-group"> 
										<label for="aC_CusName">客户姓名</label> <input type="text" 
											class="form-control" id="aC_CusName" name="aC_CusName" 
											placeholder="请输入客户姓名" value="${model.ac_CusName}"> 
									</div> 
									<div class="form-group"> 
										<label for="aC_Address">地址</label> <input type="text" 
											class="form-control" id="aC_Address" name="aC_Address" 
											placeholder="请输入地址" value="${model.ac_Address}"> 
									</div> 
									<div class="form-group"> 
										<label for="aC_AccountNum">号码</label> <input type="text" 
											class="form-control" id="aC_AccountNum" name="aC_AccountNum" 
											placeholder="请输入号码" value="${model.ac_AccountNum}"> 
									</div> 
									<div class="form-group"> 
										<label for="aC_HealthData">健康数据</label> <input type="text" 
											class="form-control" id="aC_HealthData" name="aC_HealthData" 
											placeholder="请输入健康数据" value="${model.ac_HealthData}"> 
									</div> 
									<div class="form-group"> 
										<label for="users_ID">装维人员ID</label> <input type="text" 
											class="form-control" id="users_ID" name="users_ID" 
											placeholder="请输入装维人员ID" value="${model.users_ID}"> 
									</div> 
...
<!--添加上传图片JS-->
	<script src="${ctx}/plugins/fileinput/js/fileinput.min.js"></script>
	<script src="${ctx}/plugins/fileinput/js/fileinput_locale_zh.js"></script>
	<script src="${ctx}/plugins/jQuery/jquery.validate.min.js"></script>
