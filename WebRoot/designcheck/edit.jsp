	...
	<div class="wrapper"> 
		...
		<div class="content-wrapper"> 
			...
			<section class="content-header"> 
				<h1> 
					系统设置 <small>设计管理设置</small> 
				</h1> 
				<ol class="breadcrumb"> 
					<li><a href="#"><i class="fa fa-dashboard"></i> 首页</a></li> 
					<li class="active">设计管理</li> 
				</ol> 
			</section> 
					...
					<div class="col-md-12"> 
						<div class="box box-primary"> 
							<div class="box-header with-border"> 
								<h3 class="box-title">设计管理</h3> 
							</div> 
							<!-- /.box-header --> 
							<!-- form start --> 
							<form role="form" 
								action="designcheck?action=update&dC_id=${model.dc_id}" 
								method="post"  id="form1"> 
								<div class="box-body"> 
					
									
									<div class="form-group"> 
										<label for="dC_Date">地点</label> <input type="text" 
											class="form-control" id="dC_Date" name="dC_Date" 
											placeholder="请输入地点" value="${model.dc_Date}"> 
									</div> 
									<div class="form-group"> 
										<label for="dC_Project">项目名称</label> <input type="text" 
											class="form-control" id="dC_Project" name="dC_Project" 
											placeholder="请输入项目名称" value="${model.dc_Project}"> 
									</div> 
									<div class="form-group"> 
										<label for="dC_Content">设计内容</label> <input type="text" 
											class="form-control" id="dC_Content" name="dC_Content" 
											placeholder="请输入设计内容" value="${model.dc_Content}"> 
									</div> 
									<div class="form-group"> 
										<label for="users_ID">设计人ID</label> <input type="text" 
											class="form-control" id="users_ID" name="users_ID" 
											placeholder="请输入设计人ID" value="${model.users_ID}"> 
									</div> 
