	...
	<div class="wrapper"> 
		...
		<div class="content-wrapper"> 
			...
			<section class="content-header"> 
				<h1> 
					系统设置 <small>监理管理设置</small> 
				</h1> 
				<ol class="breadcrumb"> 
					<li><a href="#"><i class="fa fa-dashboard"></i> 首页</a></li> 
					<li class="active">监理管理</li> 
				</ol> 
			</section> 
					...
					<div class="col-md-12"> 
						<div class="box box-primary"> 
							<div class="box-header with-border"> 
								<h3 class="box-title">监理管理</h3> 
							</div> 
							<!-- /.box-header --> 
							<!-- form start --> 
							<form role="form" 
								action="supervisorcheck?action=update&sC_ID=${model.sc_ID}" 
								...
								<div class="box-body"> 
									...
									<div class="form-group"> 
										<label for="sC_Address">地点</label> <input type="text" 
											class="form-control" id="sC_Address" name="sC_Address" 
											placeholder="请输入地点" value="${model.sc_Address}"> 
									</div> 
									<div class="form-group"> 
										<label for="sC_ProjectName">项目名称</label> <input type="text" 
											class="form-control" id="sC_ProjectName" name="sC_ProjectName" 
											placeholder="请输入项目名称" value="${model.sc_ProjectName}"> 
									</div> 
									<div class="form-group"> 
										<label for="sC_ProjectDesc">工程情况</label> <input type="text" 
											class="form-control" id="sC_ProjectDesc" name="sC_ProjectDesc" 
											placeholder="请输入工程情况" value="${model.sc_ProjectDesc}"> 
									</div> 
									<div class="form-group"> 
										<label for="users_ID">监理人ID</label> <input type="text" 
											class="form-control" id="users_ID" name="users_ID" 
											placeholder="请输入监理人ID" value="${model.users_ID}"> 
									</div> 
