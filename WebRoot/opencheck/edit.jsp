	...
	<div class="wrapper"> 
		...
		<div class="content-wrapper"> 
			...
			<section class="content-header"> 
				<h1> 
					系统设置 <small>开通管理设置</small> 
				</h1> 
				<ol class="breadcrumb"> 
					<li><a href="#"><i class="fa fa-dashboard"></i> 首页</a></li> 
					<li class="active">开通管理</li> 
				</ol> 
			</section> 
					...
					<div class="col-md-12"> 
						<div class="box box-primary"> 
							<div class="box-header with-border"> 
								<h3 class="box-title">开通管理</h3> 
							</div> 
							<!-- /.box-header --> 
							
							<!-- form start --> 
							<form role="form" id="form1"
								action="opencheck?action=update&oC_ID=${model.oc_ID}" 
								method="post"> 
								<div class="box-body"> 
  
									<div class="form-group"> 
										<label for="oC_ProjectNO">项目名称</label> <input type="text" 
											class="form-control" id="oC_ProjectNO" name="oC_ProjectNO" 
											placeholder="oC_ProjectNO" value="${model.oc_ProjectNO}"> 
									</div> 
									<div class="form-group"> 
										<label for="oC_ENO">设备型号</label> <input type="text" 
											class="form-control" id="oC_ENO" name="oC_ENO" 
											placeholder="oC_ENO" value="${model.oc_ENO}"> 
									</div> 
									<div class="form-group"> 
										<label for="oC_BusinessType">业务类型</label> <input type="text" 
											class="form-control" id="oC_BusinessType" name="oC_BusinessType" 
											placeholder="oC_BusinessType" value="${model.oc_BusinessType}"> 
									</div> 
									<div class="form-group"> 
										<label for="users_ID">施工人</label> 
				                                             		
                                             <input type="text" 
											class="form-control" id="oC_BusinessType" name="users_ID" 
											placeholder="请输入施工人" value = "${model.users_ID }"/> 
                                             
									</div> 
									<div class="form-group"> 
										<label for="oC_CustInfo">客户信息</label> <input type="text" 
											class="form-control" id="oC_CustInfo" name="oC_CustInfo" 
