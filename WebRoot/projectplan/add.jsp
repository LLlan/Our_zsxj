						...
						<div class="box box-primary"> 
							...
							<form role="form" id="form1"
								...
								<div class="box-body"> 
									...
									<div class="form-group"> 
										<label for="pP_ExecComName">施工单位</label> 
											<select id = "pP_ExecComName" class="form-control" name = "pP_ExecComName">
                                            ...
                                            <c:forEach items="${requestScope.branchs}" var="branch">
                                             <option value="${branch.branch_ID}">${branch_Name}</option>
                                             </c:forEach>
                                           </c:if>
                                            </select>
									</div> 
									<div class="form-group"> 
										<label for="users_ID">随工人员</label> 
	...
	<script src="${ctx}/dist/js/app.min.js"></script> 
 	...
 	<script type="text/javascript">
		...
		$("#form1").validate({
	 	...
	 	//使用ajax实现二级联动
	 	$(function(){
	 		  $("#pP_ExecComName").change(function(){
              	var id = $(this).children('option:selected').val();
              	
              	//地址
              	var url ="projectplan";
              	//参数
              	var args = {"action":"queryUser","brandId" : id,"time" : new Date()};
              	//向服务器发送请求
              	$.post(url,args,function(data){
              		...
              		$.each(json,function(i,value){
              			//初始化选项
              			str +="<option value = '"+value.users_ID+"'>" + value.users_Name +"</option>";
              		});
