					...
					<div class="col-md-12"> 
						<div class="box box-primary"> 
							...
							<form role="form" id="form1"
								action="worklist?action=update&wL_ID=${model.WL_ID}" 
								method="post"> 
								<div class="box-body"> 
									...
									<div class="form-group"> 
										...
										<select class="form-control" id="wL_UsersIDs" name="wL_UsersIDs" readonly>
											...
											<c:if test="${users.users_ID == model.WL_UsersIDs }">
											<option value="${users.users_ID }" selected="selected">${users.users_UserName }</option>
											</c:if>											
											<c:if test="${users.users_ID != model.WL_UsersIDs }">
