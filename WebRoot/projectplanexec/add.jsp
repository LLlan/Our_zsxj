					...
					<div class="col-md-12"> 
						<div class="box box-primary"> 
							...
							<form role="form" id="form1"
								action="projectplanexec?action=add" 
								method="post"> 
								<div class="box-body"> 
