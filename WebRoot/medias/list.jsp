								...
								<div class="box-tools list-inline"> 
									<ul class="list-inline"> 
										<li><a class="btn btn-block btn-success btn-flat" 
											href="${ctx}/base/medias/add.jsp">添加</a></li> 
	...
	<script type="text/javascript"> 
		$(document).ready(function() { 
			$("#jqGrid").jqGrid({ 
				...
				{ 
					label : '归属表', 
					name : 'medias_BelongtoTable', 
					width : 200 
				}, 
				{ 
					label : '归属ID', 
					name : 'medias_BelongtoID', 
					width : 200 
				} 
		...
		function editRow() { 
			...
			if (!edrowKey) 
				...
				if (edselectedIDs.length > 0) { 
					...
					location.href = "medias?action=edit&medias_ID=" 
							+ edselectedIDs[0]; 
				} else { 
