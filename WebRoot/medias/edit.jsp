	...
	<div class="wrapper"> 
		...
		<div class="content-wrapper"> 
			...
			<section class="content-header"> 
				<h1> 
					系统设置 <small>多媒体库设置</small> 
				</h1> 
				<ol class="breadcrumb"> 
					<li><a href="#"><i class="fa fa-dashboard"></i> 首页</a></li> 
					<li class="active">多媒体库</li> 
				</ol> 
			</section> 
					...
					<div class="col-md-12"> 
						<div class="box box-primary"> 
							<div class="box-header with-border"> 
								<h3 class="box-title">多媒体库</h3> 
							</div> 
							<!-- /.box-header --> 
							<!-- form start --> 
							<form role="form" id="form1"
								action="medias?action=update&medias_ID=${model.medias_ID}" 
								method="post"> 
								<div class="box-body"> 

									<div class="form-group"> 
										<label for="medias_Type">属性</label> <input type="text" 
											class="form-control" id="medias_Type" name="medias_Type" 
											placeholder="medias_Type" value="${model.medias_Type}"> 
									</div> 
									<div class="form-group"> 
										<label for="medias_Title">标题</label> <input type="text" 
											class="form-control" id="medias_Title" name="medias_Title" 
											placeholder="medias_Title" value="${model.medias_Title}"> 
									</div> 
									<div class="form-group"> 
										<label for="medias_AddTime">添加时间</label> <input type="text" 
											class="form-control" id="medias_AddTime" name="medias_AddTime" 
											placeholder="medias_AddTime" value="${model.medias_AddTime}"> 
									</div> 
									<div class="form-group"> 
										<label for="medias_Url">地址</label> <input type="text" 
											class="form-control" id="medias_Url" name="medias_Url" 
											placeholder="medias_Url" value="${model.medias_Url}"> 
									</div> 
									<div class="form-group"> 
										<label for="medias_BelongtoTable">归属表</label> <input type="text" 
											class="form-control" id="medias_BelongtoTable" name="medias_BelongtoTable" 
											placeholder="medias_BelongtoTable" value="${model.medias_BelongtoTable}"> 
									</div> 
									<div class="form-group"> 
										<label for="medias_BelongtoID">归属ID</label> <input type="text" 
											class="form-control" id="medias_BelongtoID" name="medias_BelongtoID" 
											placeholder="medias_BelongtoID" value="${model.medias_BelongtoID}"> 
									</div> 
