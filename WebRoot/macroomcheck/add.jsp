	...
	<div class="wrapper"> 
		...
		<div class="content-wrapper"> 
			...
			<section class="content-header"> 
				<h1> 
					系统设置 <small>机房巡检设置</small> 
				</h1> 
				<ol class="breadcrumb"> 
					<li><a href="#"><i class="fa fa-dashboard"></i> 首页</a></li> 
					<li class="active">机房巡检</li> 
				</ol> 
			</section> 
					...
					<div class="col-md-12"> 
						<div class="box box-primary"> 
							<div class="box-header with-border"> 
								<h3 class="box-title">机房巡检</h3> 
							</div> 
							<!-- /.box-header --> 
							<!--新增添加图片-->
							<form action="macroomcheck?action=add" 
								enctype="multipart/form-data" method="post" role="form" id="form1">
								<div class="box-body">
									...
									<div class="form-group"> 
										<label for="mRC_Address">地点名称</label> <input type="text" 
											class="form-control" id="mRC_Address" name="mRC_Address" 
											placeholder="请输入地点名称" /> 
									</div> 
									<div class="form-group"> 
										<label for="users_ID">上报人</label> <input type="text" 
	...
	<script src="${ctx}/plugins/fileinput/js/fileinput_locale_zh.js"></script>
 	<script type="text/javascript">
		...
		$("#mutilefiles").fileinput({
			uploadUrl : '${ctx}/uploadservlet', // you must set a valid URL here else you will get an error
